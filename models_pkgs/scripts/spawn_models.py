...
if __name__ == '__main__':
    ...
    req_pkg00 = create_cube_request(sdf_cube_red, "packagen00",
                              0.28, 0.37, 1.93,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size

    req_pkg01 = create_cube_request(sdf_cube_green, "packagen01",
                              0.0, 0.37, 1.93,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size
    ...
    req_pkg10 = create_cube_request(sdf_cube_green, "packagen10",
                              0.28, 0.37, 1.63,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size

    req_pkg11 = create_cube_request(sdf_cube_yellow, "packagen11",
                              0.0, 0.37, 1.63,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size
    ...
    req_pkg20 = create_cube_request(sdf_cube_yellow, "packagen20",
                              0.28, 0.37, 1.41,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size

    req_pkg21 = create_cube_request(sdf_cube_red, "packagen21",
                              0.0, 0.37, 1.41,  # position -x 1.2 -y -2.5 -z 0.94
                              0.0, 0.0, 0.0,  # rotation
                              0.15, 0.15, 0.15)  # size
